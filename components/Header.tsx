...
export default function Header({ userName, isLive, errorStatus, onToggleAssistant }: HeaderProps) {
  return (
    <header className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-6 mb-6 md:mb-16 border-b border-white/10 pb-4 md:pb-10 relative z-10 px-4 md:px-0">
      <div className="w-full md:w-auto">
        <h1 className="font-black tracking-tighter mb-2 uppercase italic leading-none flex flex-wrap items-center gap-2 sm:gap-3">
          <span className="gradient-text text-3xl sm:text-4xl md:text-5xl lg:text-6xl">JD</span>
          <span className="text-white/30 text-2xl sm:text-3xl md:text-4xl lg:text-5xl">/</span> 
          <span className="text-white/90 text-lg sm:text-xl md:text-2xl lg:text-3xl">Executive Assistant</span> 
        </h1>
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mt-3 md:mt-4">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-2 w-full md:w-auto">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-4 w-full sm:w-auto">
          <div className="glass px-4 sm:px-5 md:px-6 py-2.5 sm:py-3 md:py-3.5 rounded-lg flex items-center justify-center sm:justify-start gap-3 shadow-lg">
          ...
          <button
            ...
            className={`px-4 py-2.5 sm:py-2 rounded-lg font-black text-xs sm:text-sm tracking-wider transition-all duration-300 shadow-lg ${
              isLive 
